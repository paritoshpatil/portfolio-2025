...
export default function Photography() {
  ...
  useEffect(() => {
    ...
    images.forEach((img) => {
      if (img.complete) {
        loaded++;
        if (loaded === images.length) window.dispatchEvent(new Event("resize"));
      } else {
          ...
          <div>
            <FadeIn delay={0.2}>
              <p className="text-md text-foreground/70 text-monospace w-full mt-4 text-justify">
                ...
                preview, and each roll has a limited number of exposures. This,
                combined with the cost, encourages more intentional shooting.
                You shoot the shot and you're back in the moment, rather than
                getting caught up in endless reviews and retakes.
                <br />
                <br />
                Frame. Shoot. Go.
              </p>
