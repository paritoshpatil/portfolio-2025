...
import SocialCard from "@/components/ui/spotlight-card";
...
export default function About() {
  return (
    <main className="flex flex-col items-start justify-center h-full w-full px-4 py-12 sm:px-6 lg:px-8">
      <div className="py-32 flex flex-row h-full max-h-full">
        <ReactLenis className="h-full max-h-full overflow-hidden w-2/3 pr-8">
          <TextReveal variant="blur" className="text-5xl italic">
            Hello, nice to meet you.
          </TextReveal>
          <FadeIn
            delay={0.4}
            className="font-mono text-muted-foreground text-lg mt-8 block break-keep"
          >
        ...
        <ReactLenis className="h-full max-h-full overflow-hidden w-1/3">
          <SpotlightCard
            className="mb-8 p-20 rounded-md flex items-center justify-center"
            spotlightColor="rgba(0, 229, 255, 0.4)"
          >
            <h1 className="text-3xl italic ">I'm easiest to reach on X</h1>
          </SpotlightCard>
          <SpotlightCard
            className="mb-8 p-8 rounded-md flex items-center justify-center"
            spotlightColor="rgba(93, 228, 167, 0.4)"
          >
            <h1 className="text-3xl italic ">Or you can shoot me an email</h1>
          </SpotlightCard>
        </ReactLenis>
      </div>
    </main>
