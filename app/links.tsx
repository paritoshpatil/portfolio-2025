...
export function Links() {
  const photoTooltip = useCursorTooltip<HTMLDivElement>({
    content: (
      <TooltipCard
        title="Photography"
        description="I shoot on film, I'm better than you"
        footer="this is a collection of my cameras and photos"
      >
  ...
  const projectsTooltip = useCursorTooltip<HTMLDivElement>({
    content: (
      <TooltipCard
        title="Projects"
        description="I code in notepad, I'm better than you"
        footer="this is a collection of my projects"
      >
        <Rive
          src="possession.riv"
  ...
  return (
    <div className="flex flex-row gap-y-4 md:flex-row md:gap-x-4 md:gap-y-0">
