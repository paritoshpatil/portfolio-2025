...
export default function Artmix(props: { id?: string }) {
    return (
        <div className='info-pane flex flex-col justify-start w-full gap-8 pr-4 pl-4' id={props.id}>
            <FadeIn delay={0}>
                <h1 className="text-5xl">ArtMix</h1>
            </FadeIn>
            <div>
                <FadeIn delay={0.2}>
                    <p className="text-md text-foreground/70 text-monospace w-full mt-4 text-justify">
                        ArtMix is a hobby project I made in 2021 when the AI uprise was afoot. It uses DallE2 by OpenAI 
                        to generate famous artworks as if they were painted by a different artist. It currently has 10 artists 
                        and 10 paintings and each prompt has some randomness to it, so it is not deterministic. It is built with 
                        React and Vite and the images are served by OpenAI with the full project deployed on Vercel. 
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <Badge className="text-monospace text-background">TailwindCSS</Badge>
                    </div>
                ...
                <FadeIn delay={0.4}>
                    <div className='flex flex-row gap-4'>
                        <Button variant="ghost" size="xl" className='w-1/2 cursor-pointer'>
                            ...
                            <a href="https://github.com/paritoshpatil/artmix" target="_blank" className="no-underline">
                                <span className='text-lg'>View Artmix on Github</span>
                            </a>
                        </Button>
                        <Button variant="default" size="xl" className='w-1/2 cursor-pointer'>
                            <SquareArrowUpRight className='large-icon' />
                            <a href="https://artmix.vercel.app/" target="_blank" className="no-underline">
